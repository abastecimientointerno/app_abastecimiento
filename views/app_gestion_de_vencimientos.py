...
from components.charts_gestion_de_vencimientos import generate_bar_plot_from_line_data, generar_grafico, generate_category_bar_plot, show_chart
...
if mb52_file is not None and mb25_file is not None:
    ...
    generar_grafico(detalles_df)  # Llamada a la función para generar y mostrar el gráfico collapsible
